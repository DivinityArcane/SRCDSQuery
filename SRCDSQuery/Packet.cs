...
namespace SRCDSQuery
{
    public class Packet
    {
        ...
        public void Write (object value, Int32 offset = 0)
        {
        ...
        public R Read<R> (Int32 offset = 0)
        {
            this.location = offset > 0 ? offset : this.location;
        ...
        public void Skip (Int32 offset)
        {
            this.location += offset;
        }

        public bool CheckBounds (Int32 offset, String type_name)
        {
